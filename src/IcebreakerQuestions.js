export const ICEBREAKER_QUESTIONS = [
    ...
    "What are our respective personal goals for your next startup (e.g. a sustainable business that is spinning off cash and running it forever or high growth and some type of liquidity event)?",
    "What is your expected time commitment for your next venture (now, in 6 months, 2 years, etc.)?",
    "Do you want to raise outside money for your next venture? If so, how much – now, in 6 months, 2 years, over the life of the company?",
    "Where do you want your next business to be located?",
    ...
    "What values would you want to instill in your employees?",
